...
export const footerPages: footerPagesProps[] = [
  {
    ...
    links: [
      ...
      },
      {
        ...
        content: [
          "This web application was created as a my own digital resume and online hub. Combining a robust backend with an interactive, high-performance frontend. On the backend, Django, a powerful web framework for Python, handles the core business logic. It is containerized and deployed using Docker which ensures smooth and consistent deployment. The entire backend is hosted on an Amazon EC2 instance. GitHub Actions is used to update both the backend and frontend through AWS Open ID Connect (OIDC).",
